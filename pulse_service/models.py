...
class AnalysisJob(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            # Names pinned to match migration 0008 so makemigrations stays a
            # no-op; leaving them unnamed makes Django want to rename to an
            # autogenerated hash on every check.
            models.Index(fields=["state"], name="pulse_anal_state_idx"),
            models.Index(fields=["patient", "-created_at"], name="pulse_anal_pat_idx"),
        ]
